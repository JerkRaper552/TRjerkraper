...
if IY_LOADED and not _G.IY_DEBUG == true then
    spawn(function()
        ...
        sound.SoundId = "rbxassetid://112655800437843"
        sound.Volume = 3
    ...
    notify("I CANT LOAD", "george floyd admin is already loaded", 5, NOTIF_ICON)
    return
end
...
spawn(function()
    local sound = Instance.new("Sound")
    sound.SoundId = "rbxassetid://115444709129300"
    sound.Volume = 3
    sound.Parent = game:GetService("SoundService")
    if not sound.IsLoaded then sound.Loaded:Wait() end
    sound:Play()
...
notify("GPF ADMIN", "Successfully injected niggalink admin module", 5, NOTIF_ICON)
